...
export function fetchList(params) {
  return request({
    url: 'intellisense-floodcontrol/rainLevel/rainLevelDay',
    method: 'post',
    params: params
  })
}
export function fetchMonthList(params) {
  return request({
    url: 'intellisense-floodcontrol/rainLevel/rainLevelMonth',
    method: 'post',
    params: params
  })
}
...
export function fetchYearList(params) {
  return request({
    url: 'intellisense-floodcontrol/rainLevel/rainLevelYear',
    method: 'post',
    params: params
  })
}
