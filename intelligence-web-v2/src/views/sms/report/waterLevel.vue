  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="waterLevelTable"
        ...
        <el-table-column label="水位" width="100" align="center">
          <template slot-scope="scope">{{scope.row.waterLevel }}</template>
        </el-table-column>
        <el-table-column label="预警值" width="100" align="center">
          <template slot-scope="scope">{{scope.row.warningValue }}</template>
        </el-table-column>
        <el-table-column label="报警值" width="100" align="center">
          <template slot-scope="scope">{{scope.row.alarmingValue }}</template>
        </el-table-column>
      </el-table>
    </div>
