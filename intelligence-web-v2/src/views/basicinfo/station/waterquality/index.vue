  ...
  <el-card shadow="hover">
    <div style="margin-top: 20px">
      <el-form :inline="true" :model="formInline">
        <el-form-item label="区域">
          <el-select v-model="formInline.areaName" clearable placeholder="全部" :popper-append-to-body="false">
            <el-option
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="控制级别"  align="center">
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="form" :rules="rules">
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="PH" label-width="40px" >
              <el-input v-model="form.latitude"  minlength=1></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
