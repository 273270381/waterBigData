...
<template> 
  <div class="app-container">
    ...
    <div style="text-align:center;">{{this.stationname}}年报表</div>

    <div style="">自动站名称：{{this.stationname}}    所在区域：{{this.areaName}}   日期：{{ this.listQuery.date}}年</div>
    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="高锰酸盐指数" align="center" >
        ...
        <el-table-column label="总磷(mg/L)" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.w21011Rtd==null">--</span>
            <span v-else> {{scope.row.w21011Rtd}}
            </span>
          </template>
        </el-table-column>
        <el-table-column label="氨氮(mg/L)" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.w21003Rtd==null">--</span>
            <span v-else> {{scope.row.w21003Rtd}}
     </span>
        ...
        <el-table-column label="水温(℃)" align="center">
          <template slot-scope="scope">
            <span v-if="scope.row.w01010Rtd==null">--</span>
            <span v-else> {{scope.row.w01010Rtd}}
     </span>
          </template>
        </el-table-column>
...
<script>
  import {fetchYearList,createAdmin,updateAdmin,updateStatus,deleteAdmin,getRoleByAdmin,allocRole,fetchStationList} from '@/api/waterQualityReport.js';
