...
<template> 
  <div class="app-container">
    ...
    <div style="text-align:center;">{{this.areaName}}月报表</div>

    <div style="">   所在区域：{{this.areaName}}   日期：{{ this.listQuery.date}}月</div>
...
<script>
  import {fetchMonthList,createAdmin,updateAdmin,updateStatus,deleteAdmin,getRoleByAdmin,allocRole,fetchStationList} from '@/api/waterQualityCom.js';
