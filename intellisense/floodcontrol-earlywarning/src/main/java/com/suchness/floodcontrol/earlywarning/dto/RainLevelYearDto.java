...
@AllArgsConstructor
@NoArgsConstructor
public class RainLevelYearDto {
    private RainLevelYear rainLevelYear;
    private  double max;
    ...
    public RainLevelYearDto(RainLevelYear rainLevelYear){

        this.rainLevelYear=rainLevelYear;
        this.max=getMax();
    ...
    public Map<String ,Double> getAllValue(){
        ...
        map.put("1月",rainLevelYear.getOne());
        map.put("2月",rainLevelYear.getTwo());
        map.put("3月",rainLevelYear.getThree());
        map.put("4月",rainLevelYear.getFour());
        map.put("5月",rainLevelYear.getFive());
        map.put("6月",rainLevelYear.getSix());
        map.put("7月",rainLevelYear.getSeven());
        map.put("8月",rainLevelYear.getEight());
        map.put("9月",rainLevelYear.getNine());
        map.put("10月",rainLevelYear.getTen());
        map.put("11月",rainLevelYear.getEleven());
        map.put("12月",rainLevelYear.getTwelve());
