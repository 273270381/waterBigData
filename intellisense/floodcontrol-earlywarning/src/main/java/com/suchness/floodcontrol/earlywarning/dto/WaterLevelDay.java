...
public class WaterLevelDay implements Serializable {
    ...
    public Map<String ,Double> getAllValue(){
        ...
        map.put("0时",this.zeroHour);
        map.put("1时",this.zeroHour);
        map.put("2时",this.secondHour);
        map.put("3时",this.thirdHour);
        map.put("4时",this.fourthHour);
        map.put("5时",this.fifthHour);
        map.put("6时",this.sixthHour);
        map.put("7时",this.seventhHour);
        map.put("8时",this.eighthHour);
        map.put("9时",this.ninthHour);
        map.put("10时",this.tenthHour);
        map.put("11时",this.eleventhHour);
        map.put("12时",this.twelfthHour);
        map.put("13时",this.thirteenthHour);
        map.put("14时",this.fourteenthHour);
        map.put("15时",this.fifteenthHour);
        map.put("16时",this.sixteenthHour);
        map.put("17时",this.seventhHour);
        map.put("18时",this.eighteenthHour);
        map.put("19时",this.nineteenthHour);
        map.put("20时",this.twentiethHour);
        map.put("21时",this.twentiethFirstHour);
        map.put("22时",this.twentiethTwoHour);
        map.put("23时",this.twentiethThreeHour);
