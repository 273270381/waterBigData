...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    redirect: '/sms/map',
    name: 'sms',
    meta: {title: '实时数据', icon: 'sms'},
    children: [
      {
        path: 'map',
        name: 'map',
        component: () => import('@/views/sms/map/index'),
        meta: {title: '水文地图', icon: 'sms-flash'}
      },
      {
        path: 'report',
        name: 'report',
    ...
    children: [
      {
        path: 'manage',
        name: 'manage',
        component: () => import('@/views/alarm/manage/index'),
        meta: {title: '水质报警管理', icon: 'alarm'}
      },
      {
        path: 'count',
        name: 'count',
        component: () => import('@/views/alarm/count/index'),
    ...
    children:[
      {
        path: '/station',
        component:Layout2,
        redirect:'/basicinfo/station/hydrology',
        name:'station',
        ...
        children:[
          {
            path: 'hydrology',
            name: 'hydrology',
            component: () => import('@/views/basicinfo/station/hydrology/index'),
            meta :{title: '水文站点',icon: 'alarm'}
          },
          {
            path: 'waterquality',
            name: 'waterquality',
            component: () => import('@/views/basicinfo/station/waterquality/index'),
            meta :{title: '水质站点', icon: 'alarm'}
          }
        ]
      },
      {
      ...
      },
      {
        path:'department',
        name:'department',
        component: () => import("@/views/basicinfo/department/index"),
        meta :{title: "部门管理", icon:'alarm'}
      },
      {
        path:'drainagearea',
        name:'drainagearea',
      ...
      },
      {
        path:'revermanagers',
        name:'revermanagers',
        component: () => import("@/views/basicinfo/revermanagers/index"),
